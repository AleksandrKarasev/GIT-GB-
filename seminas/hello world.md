...
### Добавление картинок 
Чтобы  добавить внешнюю картинку : ![Картинка](https://media.istockphoto.com/id/1448152453/vector/big-data-technology-and-data-science-illustration-data-flow-concept-querying-analysing.jpg?s=612x612&w=0&k=20&c=To0lhCrVmDYdSkOUOGxGsjlYe0buj_wwGCDqYhF9p2o=)


Добавить картинку внутренюю картинку : ![Картинка](ds.pnp.png)


Добавить ссылку : [Работа с ds](https://www.kaggle.com/)

 
### Добавление цитат 

Для того чтобы добавить одиночную цитату ">"
...
Для того чтобы добавить цитату под цитатой (максимум 15 ) ">" :
>Дарова
>>Дарова
...
1. Первый нумерованыый
2. Второй нумерованнй
